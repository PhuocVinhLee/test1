    ...
    <Form @submit="submit()" class="row g-3  " id="exam_add" :validation-schema="productFormSchema" v-slot="{ errors }">
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-12">
                ...
                <div class="" v-show="image"><img :src="image" id="image" alt="user-avatar" class="d-block rounded"
                        height="200" width="300"></div>
                <div class="button-wrapper">
                    <label for="upload" class="btn btn-primary me-2 mb-2" tabindex="0">
                        <span class="d-none d-sm-block">Upload</span>
                        <i class="bx bx-upload d-block d-sm-none"></i>
                        <input class="account-file-input" type="file" multiple hidden="" name="fileSk" id="upload"
                            ref="fileSk" @change="fileSkUpload($event)" />
                    ...
                    <span v-show="file.name">
                        ...
                        </button> <span @click="delete_file" class="badge badge-center bg-primary ">x</span>
                    </span>
...
const Form_submitcode = reactive({
    question_quiz_title: yup
        ...
        .max(500, "Tên có nhiều nhất 500 ký tự."),
...
async function submit() {
   ...
   // question_quiz.answer = list_answer_local.value;
    ...
    await action_add_question_quiz(data);
