                ...
                <div class="nav-align-top mb-4">
                    <ul class="nav nav-tabs" role="tablist">
                      ...
                      //  params: { id: '65014d42b91ceb293644a6b2'}
                       ...
                       <li class="nav-item">
                        <router-link  type="button" class="nav-link " :class=" {active: route.name =='ExamQuiz' }"
                        :to="{
                        name: 'ExamQuiz',
                        query: { id: route.query.id,  page: '1'},
                    }">     
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="navs-top-home" role="tabpanel">
                            <div class="">
                                ...
                                <ListExam_submit_code style="min-height: 450px;"></ListExam_submit_code>
                                ...
                                <div class="row">
                                    <div class="col mb-3">
                                        <p>Bạn có chắc chắn nuốn xóa <span class="badge bg-label-dark">{{
                                            get_one_exam_submit_code.exam_submit_code_title }} </span>? </p>
                                    </div>
                                </div>
                                <div class="row g-2">
...
function emit_page(page) {
   // action_all_exam_submit_codes(route.query.id,page);// click vao page o duoi 
    router.push({
        name: "ExamSubmitcode", query: {id:route.query.id, page:  page }
    }
    );
}
