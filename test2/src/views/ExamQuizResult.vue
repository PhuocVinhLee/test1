                                    ...
                                    <div class="dropdown-menu p-2 " style="width: 1000px;">
                                        ...
                                        <table class="table table-dark">
                                            ...
                                            <tbody class="table-border-bottom-0">
                                                <tr v-for="answer, index2 in one_exam_quiz.list_answer">
                                                    <td>{{ index2 +1 }}</td>
                                                    <td>{{ answer.question_title }}</td>
                                                    <td>
                                                        
                                                        <span v-if="answer.answer == 0">A</span>
                                                        <span v-if="answer.answer == 1">B</span>

                                                        <span v-if="answer.answer == 2">C</span>
                                                        <span v-if="answer.answer == 3">D</span>

                                                        <span v-if="answer.answer == 4">E</span>
...
function get_data_chart() {
    ...
    data1[10] = all_result_exam_quizs_local.value.length;

    all_result_exam_quizs_local.value.map((result) => {
