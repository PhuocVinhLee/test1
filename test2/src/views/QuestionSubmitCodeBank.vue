                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item ">
                            <router-link type="button" class="nav-link"
                                :class="{ active: route.name == 'QuestionSubmitCodeBank' }" :to="{
                                ...
                                <div class="row">
                                    <div class="col mb-3">
                                        <p>Bạn có chắc chắn nuốn xóa <span class="badge bg-label-dark">{{
                                            get_one_question_submit_code_bank.question_submit_code_bank_title }} </span>? </p>
                                    </div>
                                </div>
                                <div class="row g-2">
...
import ListQuestionSubmitCode from "@/components/QuestionSubmitCodeTable.vue";
...
watchEffect(() => {
    ...
    action_all_question_submit_code_banks(route.params.id_subject,route.query.type, route.query.page);
