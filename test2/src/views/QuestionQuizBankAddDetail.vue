            ...
            <h4 v-if="1" class="fw-bold py-3 ">
                    <router-link :to="{
                     name: 'QuestionQuizBankDetailDashboard',
                       ...
                       query:{page: 1}
                    }" class="fw-bold py-3"> {{ get_one_question_quiz_bank2.question_quiz_bank_title }}
                    </router-link> 
                    ...
                    <div class="col-md-5 mb-3">
                        ...
                        <ErrorMessage name="subject_id" class="error-feedback" />
                            ...
                            <div class="table-responsive text-nowrap">
                                <QuestionQuizBankAddDetailDashboardTable></QuestionQuizBankAddDetailDashboardTable>
                                <Pagination :lenght="get_lenght_question_quiz" @page="emit_page"></Pagination>
                                <!-- chan trang -->
                            </div>

                            <div class="toast-container position-fixed bottom-0 end-0 me-4"
                                v-show="state_question_quiz_bank">
                                <div v-if="state_question_quiz_bank.modifiedCount == 1" id="liveToast"
...
import QuestionQuizBankAddDetailDashboardTable from "@/components/QuestionQuizBankAddDetailDashboardTable.vue";
...
const { get_one_question_quiz_bank,get_one_question_quiz_bank2, state_question_quiz_bank,get_all_question_quiz_banks } = storeToRefs(useQuestion_quiz_bankStore());
