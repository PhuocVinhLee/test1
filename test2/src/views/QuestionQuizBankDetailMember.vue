                ...
                <table v-else class="table ">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>Hình ảnh</th>
                            <th v-show="get_one_teacher._id ==get_one_question_quiz_bank.teacher_id ">Hành động</th>
                    ...
                    <tbody>
                        ...
                        <tr v-for="(teacher, index) in get_list_teachers" :key="teacher._id">
                            ...
                            <span v-if="get_one_question_quiz_bank.teacher_id == teacher._id"> (Chủ sỡ hữu)</span>
                          
                            </ul>
                            </td>
                            <td>
                                 <div  v-show="get_one_teacher._id ==get_one_question_quiz_bank.teacher_id " v-if="get_one_question_quiz_bank.teacher_id != teacher._id" @click="{teacher_local = teacher;}" data-bs-toggle="modal" data-bs-target="#basicModal">
...
const { action_one_question_quiz_bank,action_update_question_quiz_bank, action_add_id_teacher_submit_code_bank, action_all_question_quiz_banks, reset_state_question_quiz_bank, action_delete_question_quiz_bank } = useQuestion_quiz_bankStore();
...
function delete_teacher_id_from_question_bank(){
    let list_teacher_id_local = get_one_question_quiz_bank.value.list_teacher.filter((teacher_id)=>{
        return teacher_id != teacher_local.value._id;
    })
   
    action_update_question_quiz_bank(route.params.id_question_bank, {list_teacher: list_teacher_id_local})
